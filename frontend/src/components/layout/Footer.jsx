    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto py-8 sm:py-10 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:justify-between gap-6 sm:gap-8">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-xs sm:text-sm font-semibold text-gray-400 tracking-wider uppercase">Locations</h3>
            <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-3 md:space-y-4">
              <li>
                <a 
                  href="https://maps.app.goo.gl/CHkHPhBZDbwg873h6" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-sm sm:text-base text-gray-500 hover:text-gray-900 flex items-center justify-center sm:justify-start transition-colors"
                >
              ...
              <li>
                <a 
                  href="https://maps.app.goo.gl/qAqie3AYTha443Rw9" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-sm sm:text-base text-gray-500 hover:text-gray-900 flex items-center justify-center sm:justify-start transition-colors"
                >
          ...
          <div className="text-center sm:text-right">
            ...
            <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-3 md:space-y-4">
              <li>
                <a 
                  href="https://www.facebook.com/gyanin.academy/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
              ...
              <li>
                <a 
                  href="https://www.instagram.com/gyanin.academy/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-sm sm:text-base text-gray-500 hover:text-gray-900 flex items-center justify-center sm:justify-end transition-colors"
                >
