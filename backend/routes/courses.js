...
const courseValidation = [
  ...
  body('monthlyPrice').optional({ nullable: true }).isFloat({ min: 0 }).withMessage('Monthly price must be a positive number'),
  body('yearlyPrice').optional({ nullable: true }).isFloat({ min: 0 }).withMessage('Yearly price must be a positive number'),
