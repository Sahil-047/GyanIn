...
import { FaEnvelope, FaPhone, FaWhatsapp, FaUserGraduate, FaMapMarkerAlt, FaClock, FaMobileAlt, FaCheckCircle } from 'react-icons/fa'
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr className="hover:bg-blue-50/40">
                        ...
                        <td className="px-4 sm:px-6 py-4">
                          <a href="#" className="inline-flex items-center justify-center hover:opacity-80 transition-opacity" target="_blank" rel="noopener noreferrer" title="Download on Google Play">
                      ...
                      <tr className="hover:bg-green-50/40">
                        ...
                        <td className="px-4 sm:px-6 py-4 space-x-3 whitespace-nowrap">
                          <a href={`https://wa.me/${contactDetails.whatsapp.replace(/\s+/g, '')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center hover:opacity-80 transition-opacity" title="WhatsApp">
                      ...
                      <tr className="hover:bg-indigo-50/40">
                        ...
                        <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                          <a href={`https://maps.google.com/?q=${encodeURIComponent(contactDetails.address)}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center hover:opacity-80 transition-opacity" title="Locate on Map">
